...
Brand.create!(name: 'Adidas', user_id: 1)
Brand.create!(name: 'Beau Gosse', user_id: 1)
Brand.create!(name: 'Coco Nuts', user_id: 1)
Brand.create!(name: 'Deep Ploy', user_id: 1)
Brand.create!(name: 'En Tete', user_id: 1)
